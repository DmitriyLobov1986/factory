...
Функция ПолучитьТЗДинамическогоСписка(Строки)
	...
	ТЗ.Колонки.Добавить("ИндексСтроки",Новый ОписаниеТипов("Число",
									   Новый КвалификаторыЧисла(15, 2, ДопустимыйЗнак.Любой)));
	ТЗ.Колонки.Добавить("Ключ");
	ТЗ.Колонки.Добавить("Id_стр", Новый ОписаниеТипов("Строка", ,
...
Процедура ОпределитьПользователя(ТаблицаДС, СтрокиДС)
  ...
  Иначе
      ...
      КодыЧатовБитрикс.Колонки.Добавить("КодЧатаБитрикс", Новый ОписаниеТипов("Число", Новый КвалификаторыЧисла(15, 0, ДопустимыйЗнак.Любой)));
  КонецЕсли;	

...
////Дима 9/24/2014 11:27:27 AM////Определение объектов метаданных для запрета редактирования
  ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, "Документ.ЗаявкаНаМашину", "Дата");
  ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.ПриходМашины.ПолноеИмя(), "Дата");
  ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.Документы.ТаможняРассчёты.ПолноеИмя(), "Дата");
  ДатыЗапретаИзменения.ДобавитьСтроку(ИсточникиДанных, Метаданные.РегистрыСведений.ДДС.ПолноеИмя(), "Период");
//Конец Дима  

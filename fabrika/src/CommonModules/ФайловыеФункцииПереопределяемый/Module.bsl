...
Функция УстановитьИмяФайлаПриОтправкеДанныхФайла(ЭлементДанных, ИмяКаталогаФайлов, УникальныйИдентификатор) Экспорт
	...
	// РаботаСФайлами
	НовыйПутьФайла = ФайловыеФункцииПереопределяемый.УстановитьИмяФайлаПриОтправкеДанныхФайла(ЭлементДанных, ИмяКаталогаФайлов, УникальныйИдентификатор);
...
Процедура ДобавитьНаДискПриПолученииДанныхФайла(ЭлементДанных, ДвоичныеДанные, ПутьКФайлуНаТоме, СсылкаНаТом, ВремяИзменения, ИмяБезРасширения, Расширение, РазмерФайла, Зашифрован) Экспорт
	...
	// РаботаСФайлами
	ФайловыеФункцииПереопределяемый.ДобавитьНаДискПриПолученииДанныхФайла(ЭлементДанных, ДвоичныеДанные, ПутьКФайлуНаТоме, СсылкаНаТом, ВремяИзменения, ИмяБезРасширения, Расширение, РазмерФайла);
	// Конец РаботаСФайлами
...
Функция ЭтоЭлементФайл(ЭлементДанных) Экспорт
	...
	Если 
		// РаботаСФайлами
		ФайловыеФункцииПереопределяемый.ЭтоЭлементРаботаСФайлами(ЭлементДанных)
		// Конец РаботаСФайлами
...
Функция ПолучитьДвоичныеДанныеФайлаИПодписи(ДанныеСтроки) Экспорт
	...
	// РаботаСФайлами
	Если ФайловыеФункцииПереопределяемый.ЭтоЭлементРаботаСФайлами(ДанныеСтроки.Объект) Тогда
...
Функция ПолучитьИмяФайлаСПутемКДвоичнымДанным(ФайлСсылка) Экспорт
	...
	// РаботаСФайлами
	Если ФайловыеФункцииПереопределяемый.ЭтоЭлементРаботаСФайлами(ФайлСсылка) Тогда
...
Процедура ЗаписатьИзвлеченныйТекст(ФайлОбъект) Экспорт
	...
	// РаботаСФайлами
	Если ФайловыеФункцииПереопределяемый.ЭтоЭлементРаботаСФайлами(ФайлОбъект) Тогда
...
Функция ЕстьХранимыеФайлы(ВнешнийОбъект) Экспорт
	...
	Если ТипыВладельцев.Найти(ТипЗнч(ВнешнийОбъект)) <> Неопределено Тогда
		Возврат ПрисоединенныеФайлы.ОбъектИмеетФайлы(ВнешнийОбъект);
	КонецЕсли;
	// Конец ПрисоединенныеФайлы
...
Функция ПолучитьХранимыеФайлы(ВнешнийОбъект) Экспорт
	...
	Если ТипыВладельцев.Найти(ТипЗнч(ВнешнийОбъект)) <> Неопределено Тогда
		...
		МассивФайлов = ПрисоединенныеФайлы.ПолучитьВсеПодчиненныеФайлы(ВнешнийОбъект);
		...
		Для Каждого Файл Из МассивФайлов Цикл
			...
			ДанныеФайла.ДвоичныеДанныеФайла = ПолучитьНавигационнуюСсылкуФайла(Файл, Неопределено);
			ДанныеФайла.Текст = Файл.ТекстХранилище.Получить();

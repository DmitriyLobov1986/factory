...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
        ...
        Если Параметры.Подсистемы <> Неопределено Тогда
		    ПутиПодсистемы.Добавить(Параметры.Подсистемы);
        Иначе
            ПутиПодсистемы.Добавить("");
        КонецЕсли;
	КонецЕсли;
    ...
    Если МаксимальнаяДлинна = 0 Тогда
        МаксимальнаяДлинна = 10;
    КонецЕсли;
	...
	Для каждого СтрокаПодсистемы из ДеревоПодсистем.Строки Цикл
        ...
        Если ПутиПодсистемы.Количество() <> 1 Или ПутиПодсистемы[0].Значение <> "" Тогда
		    ДанныеГруппировки.ГруппировкаПредставление = "";
        Иначе
            ДанныеГруппировки.ГруппировкаПредставление = СтрокаПодсистемы.Название;
        КонецЕсли;
	...
	Для каждого СтрокаВарианта из ТаблицаВариантов Цикл
		...
		КонецЦикла;
		ДобавитьВариантыОтчета(ГруппировкиВариантов, СтрокаВарианта.Ключ,  СтрокаВарианта.Представление, СтрокаВарианта.Описание, СтрокаВарианта.ТипВариантаОтчета, СтрокаВарианта.Группировка, Видимость, СтрокаВарианта.Администратор, СтрокаВарианта.ВнешняяКоманда);
	КонецЦикла;
	...
	Для каждого СтрокаГруппирвоки из СгруппированныйСписокВариантовОтчетов.Строки Цикл
		...
		Если СтрокаГруппирвоки.Строки.Количество() > 0 тогда
			...
			Для каждого СтрокаВарианта из СтрокаГруппирвоки.Строки Цикл
				...
				Если Найти(ИмяОтчета, "_ДопонительнаяКоманда") = 0 тогда
...
&НаСервере
Процедура ДобавитьВариантыОтчета(ГруппировкиВариантов, Ключ, Представление, Описание, ТипВарианта, ГруппировкаРаздела, Видимость, Администратор, ВнешняяКоманда)
	...
	СтрокаВариантаОтчета.ВнешняяКоманда = ВнешняяКоманда;	

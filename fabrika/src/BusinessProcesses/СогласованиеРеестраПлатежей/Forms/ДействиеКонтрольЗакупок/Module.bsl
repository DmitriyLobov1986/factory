...
Процедура ПрочитатьРеквизитыБизнесПроцесса()
	...
	////Дима 10.05.2017 16:27:48////Проверить признак "Глоссаб"
	Глоссаб = ЗаданиеОбъект.Глоссаб;
	//конец Дима
...
Процедура НаименованиеНажатие(Элемент, СтандартнаяОбработка)
	...
	ПараметрыФормы = Новый Структура("АдресРеестра, Исполнитель, ТекущийПользователь, РольИсполнителя, УИД, Глоссаб", 
	                             АдресРеестра, Объект.Исполнитель, ТекущийПользователь, Объект.РольИсполнителя, УникальныйИдентификатор, Глоссаб);

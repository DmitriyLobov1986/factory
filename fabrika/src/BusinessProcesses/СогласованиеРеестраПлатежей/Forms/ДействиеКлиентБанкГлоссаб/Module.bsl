...
Процедура НаименованиеНажатие(Элемент, СтандартнаяОбработка)
	...
	ПараметрыФормы = Новый Структура("АдресРеестра, Исполнитель, ТекущийПользователь, РольИсполнителя, Глоссаб", АдресРеестра, Объект.Исполнитель, ТекущийПользователь, Объект.РольИсполнителя, Глоссаб);

...
Процедура НаименованиеНажатие(Элемент, СтандартнаяОбработка)
	...
	ПараметрыФормы = Новый Структура("АдресРеестра, Исполнитель, ТекущийПользователь, РольИсполнителя", АдресРеестра, Объект.Исполнитель, ТекущийПользователь, Объект.РольИсполнителя);

...
Функция ПолучитьДанныеПоAPI(База, Параметры, ХранилищеСессий, Сообщение = "") Экспорт
	...
	Прокси.Установить("http","16x-squid01.one.local", 3128);
    //
	ДопПараметры = Новый Структура("Аутентификация, Заголовки, Таймаут, ПараметрыПреобразованияJSON, Прокси", Аутентификация, ПараметрыСессии.headers, 100, ПараметрыПреобразованияJSON, Прокси);		
